...
<%--
    Danh sách kiểu hợp đồng
--%>
<spring:url value="/contractkind/add-view" var="addUrl" />
<spring:url value="/contractkind/list" var="listUrl" />
<spring:url value="/contractkind/update-view" var="updateUrl"/>

<div id="menu-map">
    <a href="#menu-toggle" id="menu-toggle"><img src="<%=request.getContextPath()%>/static/image/menu-icon.png"></a>
    <span id="web-map">Danh sách kiểu hợp đồng</span>
</div>
<div class="truong-form-chinhds panel-group">
    ...
    <form class="form-horizontal" action="${listUrl}" id="search-frm" method="get">
        <input type="hidden" name="page" id="page" value="${contractKindList.page}">
        <input type="hidden" name="provinceTotalPage" id="provinceTotalPage" value="${contractKindList.totalPage}">
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-2 control-label label-bam-trai">Tên kiểu hợp đồng</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="name" id="name1" value="${contractKindList.name}">
                </div>
            ...
            <div class="form-group">
                ...
                <label class="col-md-2 control-label label-bam-trai">Mã kiểu hợp đồng</label>
                <div class="col-md-3">
                    <input type="text" class="form-control" name="code" id="code" value="${contractKindList.code}">
                </div>
                <div class="col-md-7">
        ...
        <div class="col-md-12 truong-margin-footer0px">
            ...
            <table class="table" style="margin-bottom:0%" >
                ...
                <tr class="border-table">
                    <th class=" ann-title border-table table-giua col-md-3">Tên kiểu hợp đồng</th>
                    <th class=" ann-title border-table table-giua col-md-2">Mã kiểu hợp đồng</th>

                </tr>
                <c:if test="${contractKindList.total > 0}">
                    <c:forEach items="${contractKindList.listContractKind}" var="item">
                        <tr>
                            <td class="border-table truong-text-verticel"><a href="${updateUrl}/${item.ckId}">${item.name}</a></td>
                            <td class="border-table truong-rstable-widthper15 truong-text-verticel" style="color: black;">${item.contract_kind_code}</td>

                        </tr>
                    </c:forEach>
                    <tr class="table-tr-xam">
                        <th colspan="7"><div class="truong-padding-foot-table"> Tổng số <span style="color:red">${contractKindList.total}</span> dữ
                            liệu</div>
                            <div class="align-phai">
                                <c:if test="${contractKindList.page==1}">
                                    <img
                                ...
                                <c:if test="${contractKindList.page!=1}">
                                    ...
                                    ${contractKindList.page}
                                trên ${contractKindList.totalPage}
                                <c:if test="${contractKindList.page == contractKindList.totalPage}">
                                    <img
                                            class="truong-pagging-icon"
