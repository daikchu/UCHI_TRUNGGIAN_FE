...
<%--
    Thêm mói Loại Hợp Đồng
--%>
<spring:url value="/contractkind/add" var="addUrl" />
...
<div class="truong-form-chinhbtt">
    <div id="uchi-status">
        ...
        <c:if test="${contractKindAdd.success == false}">
            <div class="status-error"><img class="status-img" src="<%=request.getContextPath()%>/static/image/error.png">Tạo mới kiểu hợp đồng không thành công</div>
        </c:if>
                ...
                <div class="panel-body">
                    <div class="row truong-inline-field">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control ${contractKindAdd.name_!=null ? "error_input":""}" name="name" value="${contractKindAdd.name}">
                                <div class="error_tooltip">${contractKindAdd.name_}</div>
                            </div>

                            <label class="col-md-2 control-label required label-bam-phai">Mã kiểu hợp đồng</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control ${contractKindAdd.code_!=null ?"error_input":""}" name="code" value="${contractKindAdd.code}">
                                <div class="error_tooltip">${contractKindAdd.code_}</div>
                            </div>
                        </div>
                    </div>
