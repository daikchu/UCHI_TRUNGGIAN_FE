...
--%>
<spring:url value="/question-help/add" var="addUrl" />
<spring:url value="/question-help/list" var="backUrl" />

<div id="menu-map">
    <a href="#menu-toggle" id="menu-toggle"><img src="<%=request.getContextPath()%>/static/image/menu-icon.png"></a>
    <span id="web-map">Thêm mới câu hỏi trợ giúp</span>
</div>
<div class="truong-form-chinhbtt">
    <div id="uchi-status">

        <c:if test="${contractFee.success == false}">
            <div class="status-error"><img class="status-img" src="<%=request.getContextPath()%>/static/image/error.png">Tạo mới thông tin câu hỏi trợ giúp không thành công</div>
        </c:if>
    </div>
                    ...
                    <div class="row truong-inline-field">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 control-label label-bam-trai">
                                <input class="truong-check-fix" type="radio" name="type" value="${Constants.type_QASTP}" checked> Sở Tư Pháp
                                <input class="truong-check-fix" type="radio" name="type" value="${Constants.type_QATCCC}"> Tổ chức công chứng
                            </div>
                        </div>
                        <div class="form-group">
