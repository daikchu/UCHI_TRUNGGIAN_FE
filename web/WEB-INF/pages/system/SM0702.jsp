...
<%--
    Thêm mói nhóm quyền
--%>
<spring:url value="/system/create-bank" var="addUrl"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <label class="radio-inline prevent-type">
                                <input type="radio" name="active" value="1" checked>Đang hoạt động
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="active" value="0">Ngừng hoạt động
                            </label>
                        </div>
                        <div class="col-md-2"></div>
