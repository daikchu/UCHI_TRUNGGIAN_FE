...
<%--
    Danh sách ngân hàng
--%>
<spring:url value="/system/create-bank-view" var="createBankUrl"/>
<spring:url value="/system/update-bank-view" var="updateBankUrl"/>
<spring:url value="/system/bank-list" var="bankUrl"/>
<div id="menu-map">
    <a href="#menu-toggle" id="menu-toggle"><img src="<%=request.getContextPath()%>/static/image/menu-icon.png"></a>
    <span id="web-map">Danh sách ngân hàng</span>
</div>
<div class="col-md-12">
    <form class="form-horizontal" action="${bankUrl}" method="get" id="search-frm">
        <input type="hidden" name="listNumber"  value="${bankListForm.listNumber}">
        <input type="hidden" name="totalPage" id="totalPage" value="${bankListForm.totalPage}">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control" name="titleFilter" value="${bankListForm.titleFilter}">
                </div>
                <div class="col-md-2">
        ...
        <div class="panel-body">
            <div class="col-md-2 col-md-offset-10 export-button">
                <a href="${createBankUrl}"><input type="button" class="form-control luu" name="" value="Thêm mới"></a>
            </div>
            <table class="table" style="margin-bottom:0%">
                ...
                <c:if test="${bankListForm.listNumber ==0}">
                    <tr>
                        <td colspan="7"
                ...
                <c:if test="${bankListForm.listNumber > 0}">
                    <c:forEach items="${bankListForm.bankList}" var="item" varStatus="index" >
                        <tr>
                            <td class="border-table align-giua  ">${index.index +1}</td>
                            <td class="border-table" style="color: black;"><a href="${updateBankUrl}/${item.bid}">${item.name}</a></td>
                    ...
                    <tr class="table-tr-xam">
                        <th colspan="4">Tổng số ${bankListForm.listNumber} dữ
                            liệu
