...
<div id="menu-map">
    ...
    <span id="web-map">Mẫu tài sản</span>
</div>
    ...
    <form class="form-horizontal" action="<%=request.getContextPath()%>/template/privy/list" id="search-frm" method="get">
        <div class="col-md-12 truong-margin-footer0px">
            <div class="truong-re-bt col-md-12 export-button truong-image-fix">
                <a class="truong-small-linkbt" href="<%=request.getContextPath()%>/template/property/add"> <input type="button" class="form-control luu truong-image-bt "  name="" value="Thêm mới" ></a>
            ...
            <table class="table" style="margin-bottom:0%" >
                ...
                <c:if test="${page.rowCount > 0}">
                    <c:forEach items="${page.items}" var="item">
                        <tr>
                            <td class="border-table truong-rstable-widthper8" style="color: black;"><a href="<%=request.getContextPath()%>/template/property/edit/${item.id}">${item.id}</a></td>
                            <td class="border-table truong-rstable-widthper8" style="color: black;"><a href="<%=request.getContextPath()%>/template/property/edit/${item.id}">${item.name}</a></td>
                            ...
                            <td class="border-table truong-rstable-widthper8">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<%=request.getContextPath()%>/template/property/edit/${item.id}"><i class="fa fa-pencil-square-o"></i>Chỉnh sửa</a></li>
...
<div class="modal fade" id="deleteItem" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <form action="<%=request.getContextPath()%>/template/property/delete" id="delete-form" method="POST">
