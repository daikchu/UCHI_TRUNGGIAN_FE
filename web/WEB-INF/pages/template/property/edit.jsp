...
<div id="menu-map">
    ...
    <span id="web-map">Sửa thông tin mẫu hiển thị tài sản</span>
</div>
        ...
        <form class="form-horizontal" action="${update}" id="formSubmit" method="post" >
            <div class="panel panel-default" id="panel1">
                ...
                <div class="panel-body">
                    <input type="hidden" class="form-control " name="entry_user" value="${item.entry_user}">
                    <%--<input type="hidden" class="form-control " name="entry_time" value="${item.entry_time}">--%>
                    <input type="hidden" class="form-control " name="type" value="${item.type}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select name="type" class="form-control truong-selectbox-padding">
                                ...
                                <option value="01" ${item.getType().equals("01") ?"selected":""}>Nhà đất</option>
                                <option value="02" ${item.getType().equals("02") ?"selected":""}>Xe cộ</option>
                                <option value="99" ${item.getType().equals("99") ?"selected":""}>Tài sản khác</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <label class="checkbox-inline"><input type="checkbox"  name="disable" style="margin-top:0px" ${item.disable== true ?"checked":""} >Ngừng hoạt động</label>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group" style="text-align: center;margin:20px 0px;">
                ...
                <a class="btn btn-default"  style="min-width:130px;" href="<%=request.getContextPath()%>/template/property/list">Quay lại danh sách</a>
            </div>
        </form>
    </div>
