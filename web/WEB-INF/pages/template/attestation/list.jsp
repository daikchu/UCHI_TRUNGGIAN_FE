...
<div id="menu-map">
    ...
    <span id="web-map">Mẫu lời chứng</span>
</div>
<div class="truong-form-chinhds panel-group">

    <form class="form-horizontal" action="<%=request.getContextPath()%>/contracttemplate/list" id="search-frm" method="get">
        ...
        <div class="col-md-12 truong-margin-footer0px">
            <div class="truong-re-bt col-md-12 export-button truong-image-fix">
                <a class="truong-small-linkbt" href="<%=request.getContextPath()%>/attestation/add"> <input type="button" class="form-control luu truong-image-bt "  name="" value="Thêm mới" ></a>

            </div>
            <table class="table" style="margin-bottom:0%" >

                <tr class="border-table">
                    <th class=" ann-title border-table table-giua">Loại đơn vị</th>
                            ...
                            <td class="border-table truong-rstable-widthper8">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<%=request.getContextPath()%>/contracttemplate/edit/${item.id}"><i class="fa fa-pencil-square-o"></i>Chỉnh sửa</a></li>
...
<div class="modal fade" id="deleteItem" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <form action="<%=request.getContextPath()%>/contracttemplate/delete" id="delete-form" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Bạn chắc chắn xóa mẫu lời chứng này chứ, điều này có thể ảnh hưởng các đơn vị đã đồng bộ mẫu này? </p>
