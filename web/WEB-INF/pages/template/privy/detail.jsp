...
<div class="truong-form-chinhbtt">
    ...
    <div class="panel-group" id="accordion">
        <form class="form-horizontal" action="<%=request.getContextPath()%>/template/privy/add" id="formSubmit" method="get" >
...
//            pasteHtmlAtCaret("<span class='inputcontract' editable-text='newtextbox' placeholder='"+ sel.focusNode.data +"' contenteditable='true'></span> ");
            pasteHtmlAtCaret('<span class="inputcontract" editspan="newtextbox" placeholder="....." contenteditable="true"></span>',el);
        }
        else
            pasteHtmlAtCaret('<span class="inputcontract" editspan="newtextbox" placeholder="....." contenteditable="true"></span>',el);
